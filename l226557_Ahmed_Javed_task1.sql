...
INSERT [dbo].[Students] ([RollNo], [Name], [WarningCount], [Department]) VALUES ('8', 'Arsala', 1, 'CS') -- Violation of PRIMARY KEY constraint. Cannot insert duplicate key in object 'Students'. The duplicate key value is (8).
go
...
INSERT [dbo].[Courses] ([CourseID], [CourseName], [PrerequiteCourseID],CreditHours) VALUES (NULL, 'Database Systems', 20, 3) -- column does not allow nulls. INSERT fails.
...
INSERT [dbo].[Courses_Semester] ([InstructorID], [CourseID], [Semester], [Section], [AvailableSeats], [Department]) VALUES (400, 10, 'Spring2017', 'D', 45, 'CS')--The INSERT statement conflicted with the FOREIGN KEY constraint. The conflict occurred in database "Neo1", table "dbo.Instructors", column 'InstructorID'.
...
INSERT [dbo].[Courses_Semester] ([InstructorID], [CourseID], [Semester], [Section], [AvailableSeats], [Department]) VALUES (300, 11, 'Spring2017', 'A', 6, 'CS')--The INSERT statement conflicted with the FOREIGN KEY constraint. The conflict occurred in database "Neo1", table "dbo.Courses", column 'CourseID'.
...
go
Delete from dbo.Semester --The DELETE statement conflicted with the REFERENCE constraint. The conflict occurred in database "Neo1", table "dbo.Courses_Semester", column 'Semester'.
...
Update Students --Violation of PRIMARY KEY constraint. Cannot insert duplicate key in object 'dbo.Students'. The duplicate key value is (5).
